...
pipeline{
    ...
    stages {
        ...
        stage('Notify') {
            steps {
                script{
                    rancher confirm: true, credentialId: 'gt-rancher-server', endpoint: 'https://gt-rancher.hdap.gatech.edu/v2-beta', environmentId: '1a7', environments: '', image: 'gt-build.hdap.gatech.edu/jwks-server', ports: '', service: 'FHIR_Buffer_Overflow/jwks_server', timeout: 50
                }
            }
        }
    }
