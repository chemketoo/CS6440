        ...
        stage('Notify') {
            steps {
                script{
                    ...
                    rancher confirm: true, credentialId: 'rancher-server', endpoint: 'https://rancher.hdap.gatech.edu/v2-beta', environmentId: '1a7', environments: '', image: 'mysql/mysql-server:5.7', ports: '', service: 'fbo/mysql', timeout: 50
                }
            }
        }
    }
